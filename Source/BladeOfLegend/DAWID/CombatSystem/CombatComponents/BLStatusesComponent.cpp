...
void UBLStatusesComponent::GiveStatus(ECombatStatusType Status, int32 Turns)
{
	...
	switch (Status)
	{
		...
		{
			OwnerChar->SetCurrentCooldown(OwnerChar->GetCurrentCooldown() + OwnerChar->BaseData.Cooldown);
			break;
		}
		case ECombatStatusType::BLINDING:
		{
			OwnerChar->SetCurrentCooldown(OwnerChar->GetCurrentCooldown() + OwnerChar->BaseData.Cooldown * 0.5f);
			break;
		}
		...
		{
			OwnerChar->SetCurrentCooldown(OwnerChar->GetCurrentCooldown() - OwnerChar->BaseData.Cooldown * 0.3f);
			break;
		}
		case ECombatStatusType::SHIELD:
		{
			OwnerChar->SetDefendIdle(true);
			OwnerChar->SetCurrentDefense(OwnerChar->GetCurrentDefense() + OwnerChar->BaseData.BaseDefense * 3.f);
			break;
		}
		case ECombatStatusType::SNEAK:
		{
			OwnerChar->SetCurrentCooldown(0.1f);
			break;
		}
		case ECombatStatusType::INVISIBILITY:
		{
			OwnerChar->SetCurrentDodge(50.f);
			OwnerChar->GetPaperFlipbook()->SetSpriteColor(FLinearColor(OwnerChar->GetPaperFlipbook()->GetSpriteColor().R,
														OwnerChar->GetPaperFlipbook()->GetSpriteColor().G,
														OwnerChar->GetPaperFlipbook()->GetSpriteColor().B, 0.6f));
			break;
		}
		case ECombatStatusType::DMG_BOOST:
		{
			OwnerChar->SetCurrentAttackDMG(OwnerChar->BaseData.BaseAttackDMG * 1.1f);
			break;
		}
		case ECombatStatusType::ASTRAL_PROTECTION:
		{
			OwnerChar->SetCurrentDefense(OwnerChar->GetCurrentDefense() + OwnerChar->BaseData.BaseDefense * 3.f);
			OwnerChar->SetMagicImmunity(true);
			break;
		}
		default: break;
	}
...
void UBLStatusesComponent::RemoveStatus(ECombatStatusType Status)
{
	...
	switch (Status)
	{
		...
		case ECombatStatusType::SPEEDUP:
		{
			OwnerChar->SetCurrentCooldown(OwnerChar->GetCurrentCooldown() + OwnerChar->BaseData.Cooldown * 0.7f);
			break;
		}
		case ECombatStatusType::INSPIRATION:
		{
		...
		case ECombatStatusType::SHIELD:
		{
			OwnerChar->SetDefendIdle(false);
			OwnerChar->SetCurrentDefense(OwnerChar->GetCurrentDefense() - OwnerChar->BaseData.BaseDefense * 3.f);
			break;
		}
		case ECombatStatusType::SNEAK:
		{
			OwnerChar->SetCurrentCooldown(OwnerChar->BaseData.Cooldown);
			break;
		}
		case ECombatStatusType::INVISIBILITY:
		{
			OwnerChar->SetCurrentDodge(OwnerChar->BaseData.BaseDodge);
			OwnerChar->GetPaperFlipbook()->SetSpriteColor(FLinearColor(OwnerChar->GetPaperFlipbook()->GetSpriteColor().R,
														OwnerChar->GetPaperFlipbook()->GetSpriteColor().G,
														OwnerChar->GetPaperFlipbook()->GetSpriteColor().B, 1.f));
			break;
		}
		case ECombatStatusType::DMG_BOOST:
		{
			OwnerChar->SetCurrentAttackDMG(OwnerChar->BaseData.BaseAttackDMG);
			break;
		}
		case ECombatStatusType::ASTRAL_PROTECTION:
		{
			OwnerChar->SetCurrentDefense(OwnerChar->GetCurrentDefense() - OwnerChar->BaseData.BaseDefense * 3.f);
			OwnerChar->SetMagicImmunity(false);
			break;
		}
		default: break;
	}
